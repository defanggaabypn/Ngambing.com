...
<title>Order <?php echo e($order->invoice); ?> - Ngambing.com</title>
                            ...
                            <div class="card-body">
                                <table>
                                    <tr>
                                        ...
                                        <td width="5%">:</td>
                                        <th><a href="<?php echo e(route('customer.order_pdf', $order->invoice)); ?>"
                                                target="_blank"><strong><?php echo e($order->invoice); ?></strong></a></th>
                                    </tr>
                                    <tr>
                                        <td>Nama Lengkap</td>
                                        <td width="5%">:</td>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">
                                    ...
                                    <a href="<?php echo e(url('member/payment?invoice=' . $order->invoice)); ?>"
