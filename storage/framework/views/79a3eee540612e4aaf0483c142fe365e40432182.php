<?php $__env->startSection('title'); ?>
    <title>List Pesanan - Ngambing.com</title>
                                        ...
                                        <table class="table table-hover table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo e(number_format($row->subtotal)); ?></td>
                                                    ...
                                                    <td>
                                                        <form action="<?php echo e(route('customer.order_accept')); ?>" 
                                                            ...
                                                            <a href="<?php echo e(route('customer.view_order', $row->invoice)); ?>" class="btn btn-primary btn-sm mr-1">Detail</a>
                                                            <input type="hidden" name="order_id" value="<?php echo e($row->id); ?>">
                                                            
                                                            <?php if($row->status == 3 && $row->return_count == 0): ?>
                                                                <button class="btn btn-success btn-sm">Terima</button>
                                                                <a href="<?php echo e(route('customer.order_return', $row->invoice)); ?>" class="btn btn-danger btn-sm mt-1">Return</a>
                                                            <?php endif; ?>
                                                        </form>
                                                    </td>
                                                </tr>
