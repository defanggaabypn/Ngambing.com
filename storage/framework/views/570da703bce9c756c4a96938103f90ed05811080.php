                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="media">
                                        <div class="d-flex">
                                            <img src="<?php echo e(asset('storage/products/' . $row['product_image'])); ?>"
                                ...
                                <td>
                                    <div class="product_count">
                                        ...
                                        <input type="text" name="qty[]" id="sst<?php echo e($row['product_id']); ?>" maxlength="12"
                                            value="<?php echo e($row['qty']); ?>" title="Quantity:" class="input-text qty">
            ...
            <tr class="out_button_area">
                ...
                <td>
                    <div class="checkout_btn_inner">
                        <a class="gray_btn" href="<?php echo e(route('front.product')); ?>">Lanjutkan Belanja</a>
                        <a class="main_btn" href="<?php echo e(route('front.checkout')); ?>">Lanjutkan Pembayaran</a>
                    </div>
                </td>
            </tr>
            </tbody>
