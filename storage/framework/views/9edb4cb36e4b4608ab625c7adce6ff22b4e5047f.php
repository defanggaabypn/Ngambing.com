...
<title>Login - Ngambing.com</title>
        ...
        <div class="row">
            <div class="offset-md-3 col-lg-6">
                ...
                <div class="login_form_inner">
                    ...
                    <form class="row login_form" action="<?php echo e(route('customer.post_login')); ?>" method="post"
